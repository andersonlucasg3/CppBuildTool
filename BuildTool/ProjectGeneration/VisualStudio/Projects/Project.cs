...
public class Project : TTagGroup<IIndentedStringBuildable>
{
    ...
    public Project(ProjectDependencies InProjectDependencies)
    {
        List<IIndentedStringBuildable> ContentsList = [
            ...
            new Target("Build", $"pwsh -c ./Programs/DotNet/ProjectTools/Scripts/Compile.ps1 -Project {InProjectDependencies.ProjectName} -Platform $(Platform) -Configuration $(Configuration) -Modules $(ProjectName)"),
            new Target("Clean", $"pwsh -c ./Programs/DotNet/ProjectTools/Scripts/Compile.ps1 -Project {InProjectDependencies.ProjectName} -Platform $(Platform) -Configuration $(Configuration) -Modules $(ProjectName) -Clean"),
